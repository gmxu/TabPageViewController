...
extension TabCollectionCell {
    ...
    func highlightTitle() {
        ...
        itemLabel.font = option.highlightedFont ?? UIFont.boldSystemFontOfSize(option.fontSize)
    }

    func unHighlightTitle() {
        itemLabel.textColor = option.defaultColor
        itemLabel.font = option.unhighlightedFont ?? UIFont.systemFontOfSize(option.fontSize)
    }
}
